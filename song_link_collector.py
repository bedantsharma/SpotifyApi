...
# after running this code you have to manually open /tracks for the code to work
...
def tracks():
    ...
    for playlist in playlists:
        ...
        playlist_response = requests.get(f'{API_BASE_URL}playlists/{playlist_id}/tracks', headers=headers)
        playlist_tracks = playlist_response.json().get('items', [])
        
        for track in playlist_tracks:
            track_info = track['track']
            track_link = track_info['external_urls']['spotify']
            all_tracks.append(track_link)
